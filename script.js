  ...
  const runCommand = rawInput => {
    ...
    switch (command) {
      ...
      case 'projects':
        ...
        break;
      case 'experience':
        writeTerminal('Publicis Digital Experience (May 2026 – Present): Software Developer (HINCOL &amp; Hinduja Hospital) · Publicis Digital Experience (Jan 2023 – May 2026): Associate Software Developer (Disney+ Hotstar &amp; Citroën) · Publicis Media (Jan 2022 – Jul 2022): Software Developer &amp; Project Management Intern (Magento 2, PWA Studio, GraphQL) · Education: MCA (Machine Learning) SPIT Mumbai (8.65 / 10 CGPI) &amp; B.Sc. Computer Science DG Ruparel College (7.91 / 10 CGPI)');
        break;
      case 'contact':
